...
class GameTests2: XCTestCase{
    ...
    func testRegularServeGamep2() {
        ...
        XCTAssertEqual(viewController.game.extendClass.currentServe, 1) // E
    }
    ...
    func testNormalServeSwitching() {
            game.extendClass.tieBreak = false
            game.extendClass.gamep1 = 1
            game.extendClass.gamep2 = 1
        viewController.logic.serve()
            
            XCTAssertEqual(game.extendClass.currentServe, 1, "Server should be Player 1 at even total games")
            
            game.extendClass.gamep1 += 1
        viewController.logic.serve()
            
            XCTAssertEqual(game.extendClass.currentServe, 2, "Server should switch to Player 2 at odd total games")
        }

    func testPlayer1WinsFinalSet() {
            game.extendClass.setplayer1 = 2
            game.extendClass.setplayer2 = 2
            game.extendClass.gamep1 = 6
            game.extendClass.gamep2 = 4
            
        viewController.logic.finalSet()
            
            XCTAssertEqual(game.extendClass.setplayer1, 3, "Player 1 should win the final set")
            XCTAssertEqual(game.extendClass.setplayer2, 2, "Player 2 should remain at 2 sets")
        }

        func testPlayer2WinsFinalSet() {
            game.extendClass.setplayer1 = 2
            game.extendClass.setplayer2 = 2
            game.extendClass.gamep1 = 5
            game.extendClass.gamep2 = 6
            
            viewController.logic.finalSet()
            
            XCTAssertEqual(game.extendClass.setplayer2, 3, "Player 2 should win the final set")
            XCTAssertEqual(game.extendClass.setplayer1, 2, "Player 1 should remain at 2 sets")
        }
